...
is officially representing the community in public spaces. Examples include using an official
email address, posting via an official social media account, or acting as an appointed
representative at an online or offline event.

## Enforcement

Report abusive, harassing, or otherwise unacceptable behavior privately through a
[GitHub security advisory](https://github.com/zaydzaari/RemoteCraft/security/advisories/new).
Do not include unrelated secrets or credentials in the report. All complaints will be reviewed
and investigated promptly and fairly, and community leaders will respect the privacy and
...
available at the [Contributor Covenant website][version]. Community Impact Guidelines were
inspired by [Mozilla's code of conduct enforcement ladder][mozilla].
